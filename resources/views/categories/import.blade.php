<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Import Kategori dari Excel</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('categories.import-excel') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4 p-3 bg-yellow-50 rounded text-sm">
                        ...
                        <ul class="list-disc ml-5 mt-1">
                            <li><strong>nama_kategori</strong> (wajib, max 255 karakter, unik)</li>
                        </ul>
                        <p class="mt-2"><a href="{{ route('categories.export-excel') }}"
